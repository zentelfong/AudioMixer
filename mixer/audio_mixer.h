...
public:
    ...
    int32_t Mix(void* output_buffer) override;

    int32_t AddRecordedDataAndMix(const void* data, int32_t size, void* output_buffer) override;
